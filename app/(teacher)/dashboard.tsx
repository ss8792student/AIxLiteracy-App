...
import { getStudentsByTeacher } from '../../src/services/db/students';
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            ...
            >
              <View style={styles.studentLeft}>
                {item.needsIntervention && <Text style={styles.alertDot}>⚠️</Text>}
                <View>
              ...
              <View style={styles.studentRight}>
                <Text style={styles.sessionCount}>{item.sessionsThisWeek} sessions this week</Text>
                {item.averageScore > 0 && (
                  <Text style={[
                    styles.avgScore,
          ...
          ListEmptyComponent={
            <View style={styles.empty}>
              ...
              <Text style={styles.emptySubText}>Add students via "Who's Reading Today?"</Text>
            </View>
          }
        />
      )}
...
const styles = StyleSheet.create({
  ...
  emptySubText: { fontSize: 14, color: '#7B8D9E', marginTop: 8, textAlign: 'center' },
});
